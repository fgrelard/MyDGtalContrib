...
*
*=========================================================================*/
#ifndef __itkStrainEnergyVesselnessImageFilter_h
#define __itkStrainEnergyVesselnessImageFilter_h
...
namespace itk {
/** \class StrainEnergyVesselnessImageFilter
 ...
 */
    ...
    class ITK_EXPORT StrainEnergyVesselnessImageFilter :
            public BinaryFunctorImageFilter2<TInputImage1, TInputImage2, TOutputImage> {
    public:
        /** Standard class typedefs. */
        typedef StrainEnergyVesselnessImageFilter Self;
        ...
        itkTypeMacro(StrainEnergyVesselnessImageFilter, BinaryFunctorImageFilter2);
        ...
        typedef StrainEnergyVesselnessFunctor <
    ...
    protected:
        StrainEnergyVesselnessImageFilter() {
        ...
        virtual ~StrainEnergyVesselnessImageFilter() {}

    private:
        StrainEnergyVesselnessImageFilter(const Self &); // purposely not implemented
        void operator=(const Self &);                    // purposely not implemented

    }; // end class StrainEnergyVesselnessImageFilter
